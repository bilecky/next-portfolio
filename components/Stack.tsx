...
function Stack({}: Props) {
  ...
  return (
    <section
      ref={stackRef}
      id="stack"
      className="stack relative py-24 text-background will-change-transform"
    >
      <div className="overview-wrapper container">
        <div className="overview ml-auto text-right lg:max-w-contentWidth">
          <h2 className="tech-header font-mainHeaderFont text-mobile uppercase leading-none lg:text-section-header-lg xl:text-section-header-xl 2xl:text-section-header-2xl max-fold:text-fold-text">
            <Splitter
