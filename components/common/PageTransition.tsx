...
const PageTransition = ({ children }: PageTransitionProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={transitionRef}
        className="page-transition absolute left-0 top-0 h-screen w-full translate-y-[-100%] transform-gpu bg-secondBackground will-change-transform dark:bg-background"
      />
      {children}
    </div>
  );
