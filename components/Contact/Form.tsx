    ...
    >
      ...
      <div className="relative w-full">
        <input
          ...
          className={clsx(
            "contact_input w-full border-b-2 border-b-gray-500 bg-transparent px-4 py-4 placeholder:text-gray-500 focus:border-b-background focus:outline-none dark:border-b-gray-200 dark:placeholder:text-gray-400",
            {
      ...
      <div className="relative w-full">
        <textarea
          ...
          className={clsx(
            "contact_input w-full resize-none border-b-2 border-b-gray-500 bg-transparent px-4 py-4 placeholder:text-gray-500 focus:border-b-background focus:outline-none dark:border-b-gray-200 dark:placeholder:text-gray-400",
            {
