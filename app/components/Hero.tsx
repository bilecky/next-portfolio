...
const Hero = ({ setIntroComplete }: HeroProps) => {
  ...
  return (
    <section
      ref={heroRef}
      className="hero container flex h-auto w-full flex-col py-40 font-mainFont text-background opacity-0 lg:h-screen lg:flex-row-reverse lg:items-end lg:py-20 landscape-short:h-auto dark:text-mainFontColor"
    >
      ...
      <div className="section-right pt-10 md:flex-grow lg:pt-0">
        <nav className="max-fold:text-fold-text relative z-0 flex font-mainHeaderFont text-6xl font-[400] tracking-wide md:text-[6rem] lg:text-[8rem] 2xl:text-[10.5rem]">
