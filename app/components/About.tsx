...
const About = () => {
  ...
  return (
    <section className="about panel absolute top-0 z-10 col-start-1 col-end-2 row-start-1 row-end-2 w-full overflow-hidden bg-background py-20 shadow-xl will-change-transform lg:py-36">
